...
magentech.spMagentechDisplay = function(view) {
	...
	if (view == 'list')
	{
		...
		$('#js-product-list .product-miniature').each(function(index, element) {
			...
			$(this).find('.left-block').addClass('col-xs-5 col-lg-5 col-xl-4');
			$(this).find('.product-info').addClass('col-xs-7 col-lg-7 col-xl-8');
		});
	...
	{	
		...
		$('#js-product-list .product-miniature').each(function() {
			$(this).removeClass('col-xs-12').removeClass(old_col).addClass('product-miniature js-product-miniature col-xs-6 col-sm-6 col-md-6 '+ sp_gridproduct);
		});
		$('#js-product-list .product-miniature').each(function(index, element) {
			...
			$(this).find('.left-block').removeClass('col-xs-5 col-lg-5 col-xl-4');
			$(this).find('.product-info').removeClass('col-xs-7 col-lg-7 col-xl-8 ');
		});
		$('.category-view-type-selector').removeClass('selected');
		$('.grid').addClass('selected');
...
$(window).on("load", function() {
	...
	if (($(window).width()+scrollCompensate()) < 768){
		if($(".footer-links .title-footer").length){
			$(".footer-links .title-footer").click(function(){
					if($(this).hasClass('footer_c'))
						$(this).addClass('footer_o').removeClass('footer_c');
					else
						$(this).addClass('footer_c').removeClass('footer_o');
					$(this).next('.links').toggle(300);
			});
		}
	}
});
...
$(document).ready( function(){
	function _forProductDetail () {
		if ($('.images-container .product-images').length){
			$('.images-container .product-images').slick({
				slidesToShow: parseInt($('.images-container .product-images').attr('data-thumb')),
				slidesToScroll: 1,
				vertical: $('.images-container .product-images').attr('data-thumbtype') == "false" ? false : true,
				infinite: false,
				arrows: true,
				responsive: [
					{
        ...
        function _elevatezoom () {
				...
				if (_productzoom == 1 && $('.js-qv-product-cover').length && $(window).width() > 768) {
	...
	$('body').on("click",".thumb.js-thumb",function(){
		if ($('.product-cover').attr('data-productzoom') == 1 && $('.js-qv-product-cover').length) {
			_elevatezoom();
		}
	});
	...
	if($( ".spremove-button" ).length){
		$( ".spremove-button" ).click(function() {
			$( ".header-top" ).remove();
		});
	}
	...
	if($( ".button-video" ).length){
		...
		var _tag_id  = $("#sp_extra_slider_5_151641272926478");
		$('.product-biger .image-thumnail ul' , _tag_id).owlCarousel({
			pagination: false,
			center: false,
			nav: true,
			dots: false,
		...
		$('.product-biger .thumb-image').on('mouseover touchstart', function (e){
			e.preventDefault();
			var _lg_img = $(this).attr('data-image-large-src');
			var _md_img = $(this).attr('data-image-medium-src');
			$(this).closest('.product-biger').find('.image-thumnail ul li img').removeClass();
			$(this).addClass('thumb-selected');
			$(this).closest('.product-biger').find('.img_1').attr('src',_lg_img);
			$(this).closest('.product-biger').find('.img_1').attr('data-full-size-image-url',_lg_img);
		});
	
		$('.button-sticky-bottom').click(function() {
			if($('#sp-megamenu').hasClass('sp-megamenu-active') && !$(this).parent().hasClass('mobile-megamenu')){
